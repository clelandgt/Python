...
class Routes:
    ...
    def __init__(self, file_path):
        assert self.read_file(file_path) == True
    ...
    # get count of trips .
    def trips_count_within_stations_count(self, town_start, town_end, stations_counter, max_stations):
        routes = 0
        ...
        if town_start in self.route_table and town_end in self.route_table:
            ...
            if stations_counter >= max_stations:
                return 0
            ...
            while current_station:
                if current_station.destination == town_end:
                    ...
                    routes += self.trips_count_within_stations_count(current_station.destination,
                                                                    town_end, stations_counter, max_stations)
    ...
    # find shortest trip between two town
